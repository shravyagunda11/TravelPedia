...
import { hotelInputs } from "../../Sources";
...
//using the html rendering for new hotel to be added 
const NewHotel = () => {
...
//fetching data from the rest apis 
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      //posting the values into the hotels pages 
